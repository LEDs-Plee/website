...
<div class="mb-5 p-5 bg-dark text-white">
    <div class="container">
        ...
        @foreach($toilets as $toilet)
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">                    <svg class="card-img-bottom" xmlns="http://www.w3.org/2000/svg" width="200" height="200"
                    ...
                    <svg class="card-img-bottom washer {{$washer->jobState}}" xmlns="http://www.w3.org/2000/svg" width="200"
                        ...
                        <defs>
                            <clipPath id="washer-window">
                                <circle cx="60" cy="80" r="27.5" stroke="black" stroke-width="5" fill="lightblue"/>
                            </clipPath>
                            <g id="bubble">
                                <circle cx="-2.5" cy="-2.5" r="5" stroke="white" stroke-width="1" fill="darkgrey"
                                        opacity="50%"/>
                        ...
                        <rect x="75" y="20" width="30" height="10" rx="2" stroke="black" stroke-width="2" fill="green"/>
